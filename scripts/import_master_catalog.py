...
EXERCISES += [
    ...
    E("Толкание саней", "Сани толкаются вперёд руками из наклонного положения корпуса на дистанцию.", stats=("strength", "agility"), patterns=["squat"], muscles=FULLBODY_POWER_M, equip=["gym_machine"], stimulus="power", diff=2, vtype="sr", vol=(4, 1, 1)),
    E("Тяга саней", "Сани тянутся на ремне/верёвке шагом назад или вперёд на дистанцию.", stats=("strength", "agility"), patterns=["hip_hinge"], muscles=FULLBODY_POWER_M, equip=["gym_machine"], stimulus="power", diff=2, vtype="sr", vol=(4, 1, 1)),
]
...
EXERCISES += [
    ...
    E("Тяга саней спиной вперёд", "Движение спиной вперёд с сопротивлением саней, акцент на квадрицепс и контроль торможения.", stats=("strength", "agility"), patterns=["squat"], muscles=SQUAT_M, equip=["gym_machine"], stimulus="power", diff=3, vtype="sr", vol=(4, 1, 1)),
