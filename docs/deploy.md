...
```
JWT_SECRET_KEY=***REMOVED-LEAKED-SECRET***
POSTGRES_PASSWORD=***REMOVED-LEAKED-SECRET***
RABBITMQ_PASSWORD=***REMOVED-LEAKED-SECRET***
VAPID_PRIVATE_KEY=***REMOVED-LEAKED-SECRET***
VAPID_PUBLIC_KEY=***REMOVED-LEAKED-SECRET***
```
