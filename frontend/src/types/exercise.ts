...
export const TARGET_STAT_DESCRIPTIONS: Record<TargetStat, string> = {
  ...
  on_ice_skating:
    'Скорость и техника катания — определяется тестом на льду, а не обычными тренировками. Обновляется при переоценке в начале нового тренировочного блока.',
  puck_handling:
    'Контроль шайбы клюшкой на скорости — определяется тестом на льду, а не обычными тренировками. Обновляется при переоценке в начале нового тренировочного блока.',
}
